...
try:
    ...
    from NetMon_Files.Python.Main_server import start_mitmproxy , response,request
        ...
        if option_index == 0:  # Trigger Traffic Agent
            ...
            try:
                ...
                command = (
                    ...
                    f'\'"{python_executable} -c \\"from NetMon_Files.Python.Main_server import start_mitmproxy; start_mitmproxy()\\""\''  
